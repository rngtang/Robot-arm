...
labelPlayer1 = tk.Label(inner_frame1, text="You Won!", font=("Arial", 15), bg='#00539B', foreground="white")
labelPlayer1.grid(row=0, column=0, padx=10, pady=(90, 5))
...
button_restartPlayer1.grid(row=1,column=0,padx=90, pady=(5, 90))
...
labelPlayer2 = tk.Label(inner_frame2, text="Mr.Robo Won!", font=("Arial", 15), bg='#00539B',  foreground="white")
labelPlayer2.grid(row=0, column=0,padx=10,pady=(90, 5))
...
button_restartPlayer2.grid(row=1,column=0,padx=10,pady=(5, 90))
# button_restartPlayer1.grid_remove()
...
labelPlayer3 = tk.Label(inner_frame3, text="It was a draw!", font=("Arial", 15), bg='#00539B',  foreground="white")
labelPlayer3.grid(row=0, column=0,padx=10,pady=(90, 5))
...
button_restartPlayer3.grid(row=1,column=0,padx=10,pady=(5, 90))
# button_restartPlayer1.grid_remove()
