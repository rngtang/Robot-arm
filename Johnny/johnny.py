...
mc.send_angles([90, 90, 0, 0, 0, 0], 30)
time.sleep(3)
...
# Plan the route at random, let the head reach the coordinates of [57.0, -107.4, 316.3]
# in an non-linear manner at the speed is 80mm/s
# mc.send_coords([-283.2, -62.7, 169.4, 2.1, 0.27, -90.42], 30, 0)
# wait for 2 seconds
# time.sleep(2)

# Plan the route at random, let the head reach the coordinates of [207.9, 47, 49.3,-159.69]
# in an non-linear manner at the speed is 80mm/s
